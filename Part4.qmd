...
ggplot(stability_data[1:3, ], 
  ...
  theme_minimal()
```
Guinea-Bissau, Bangladesh, and Thailand exhibit the highest frequencies of regime change, indicating they are among the least politically stable countries in the dataset.
